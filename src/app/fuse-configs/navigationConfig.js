...
const navigationConfig = [
	{
		...
		children: [
			...
			// IS USER CATEGORY
			{
				id: 'is-user-no-group-selected',
				title: 'isUser - no group selected',
				type: 'group',
				icon: 'web',
				children: [
					{
					...
					},
					{
						...
						translate: 'DOWNLOADSTREAM',
						type: 'item',
						icon: 'cloud_download',
						url: '/downloaded-stream'
					},
				]
			},
			// IS USER CATEGORY
			{
				id: 'is-user',
				title: 'isUser - group is selected',
				type: 'group',
				icon: 'web',
				children: [
					{
					...
					},
					{
						...
						type: 'link',
						icon: 'cloud_download',
						url: 'https://153.149.159.17/andohazama/TP/TP001_Login.php'
					},
					{
						id: 'buildee',
						title: 'Buildee',
					...
					},
					{
						...
						type: 'link',
						icon: 'cloud_download',
						url: 'https://portal.kensetsu-site.com/login'
					},
					{
						id: 'riskprediction',
