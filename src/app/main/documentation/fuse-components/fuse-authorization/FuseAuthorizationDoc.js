			...
			content={
				<div className="p-24 max-w-2xl">
					<Typography className="mb-16" component="p">
						...
						the unauthorized user access with looking <b>route configs</b> and <b>user.role</b>.
					</Typography>
					...
					<Typography className="mb-16" component="p">
						You need to define authorization (auth) in the <b>route config files</b> for to control the
					...
					<Typography className="my-16" component="p">
						You can also give different auth values for individual routes with writing auth value inside the
						route object.
					</Typography>
					...
					<Typography className="mb-16" component="p">
						After configuring to make whole app protected as above, we need to set <code>auth:null</code> at
						the route: <code>/</code> for to make it accesible for everyone.
						<br />
						If you redirect main route (/), also make sure to set the redirected route config
						<code>auth:null</code>.
					</Typography>
